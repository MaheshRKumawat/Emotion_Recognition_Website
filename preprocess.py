...
#     "Emotion-Recognition-using-Text-with-Emojis-and-Speech/model/bi-lstm.h5", compile=False)
# bert_model = load_model(
#     "Emotion-Recognition-using-Text-with-Emojis-and-Speech/model/bert_model.h5", compile=False)
